object FrmDicionario_Reli_Pop: TFrmDicionario_Reli_Pop
  Left = 591
  Top = 83
  Hint = 'Paises que Falam Portugu'#234's'
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Dicion'#225'rio Religioso Ling'#252#237'stico - Modo Pop-up'
  ClientHeight = 626
  ClientWidth = 426
  Color = clBtnText
  ...
  PopupMenu = Dicionario_Reli_PpMenu
  ...
  object Web: TWebBrowser
    ...
    TabOrder = 3
    ControlData = {
      4C0000008C290000192B00000000000000000000000000000000000000000000
  ...
  object Dicionario_Reli_PpMenu: TPopupMenu
    Left = 88
    Top = 216
